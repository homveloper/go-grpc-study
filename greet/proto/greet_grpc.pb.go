...
type GreetServiceClient interface {
	Greet(ctx context.Context, in *RequestGreet, opts ...grpc.CallOption) (*ResponseGreet, error)
	GreetManyTimes(ctx context.Context, in *RequestGreet, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error)
...
func (c *greetServiceClient) Greet(ctx context.Context, in *RequestGreet, opts ...grpc.CallOption) (*ResponseGreet, error) {
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *RequestGreet, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
...
func (x *greetServiceGreetManyTimesClient) Recv() (*ResponseGreet, error) {
	m := new(ResponseGreet)
...
type GreetService_LongGreetClient interface {
	...
	CloseAndRecv() (*ResponseGreet, error)
	grpc.ClientStream
}
...
func (x *greetServiceLongGreetClient) Send(m *RequestGreet) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceLongGreetClient) CloseAndRecv() (*ResponseGreet, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(ResponseGreet)
...
func (x *greetServiceGreetEveryoneClient) Send(m *RequestGreet) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneClient) Recv() (*ResponseGreet, error) {
	m := new(ResponseGreet)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	Greet(context.Context, *RequestGreet) (*ResponseGreet, error)
	GreetManyTimes(*RequestGreet, GreetService_GreetManyTimesServer) error
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *RequestGreet) (*ResponseGreet, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Greet not implemented")
}
func (UnimplementedGreetServiceServer) GreetManyTimes(*RequestGreet, GreetService_GreetManyTimesServer) error {
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).Greet(ctx, req.(*RequestGreet))
	}
...
func (x *greetServiceGreetManyTimesServer) Send(m *ResponseGreet) error {
...
type GreetService_LongGreetServer interface {
	SendAndClose(*ResponseGreet) error
...
func (x *greetServiceLongGreetServer) SendAndClose(m *ResponseGreet) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceLongGreetServer) Recv() (*RequestGreet, error) {
	m := new(RequestGreet)
...
func (x *greetServiceGreetEveryoneServer) Send(m *ResponseGreet) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneServer) Recv() (*RequestGreet, error) {
	m := new(RequestGreet)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
